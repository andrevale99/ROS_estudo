...
static const _RqtLaserScan_Request_type_support_symbol_names_t _RqtLaserScan_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_to_gazebo, srv, RqtLaserScan_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_to_gazebo, srv, RqtLaserScan_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces_to_gazebo, srv, RqtLaserScan_Request)() {
  return &::interfaces_to_gazebo::srv::rosidl_typesupport_c::RqtLaserScan_Request_message_type_support_handle;
}
...
static const _RqtLaserScan_Response_type_support_symbol_names_t _RqtLaserScan_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_to_gazebo, srv, RqtLaserScan_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_to_gazebo, srv, RqtLaserScan_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces_to_gazebo, srv, RqtLaserScan_Response)() {
  return &::interfaces_to_gazebo::srv::rosidl_typesupport_c::RqtLaserScan_Response_message_type_support_handle;
}
...
static const _RqtLaserScan_type_support_symbol_names_t _RqtLaserScan_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_to_gazebo, srv, RqtLaserScan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_to_gazebo, srv, RqtLaserScan)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, interfaces_to_gazebo, srv, RqtLaserScan)() {
  return &::interfaces_to_gazebo::srv::rosidl_typesupport_c::RqtLaserScan_service_type_support_handle;
}
